        ...
        /* Full version of the plugin with universal platform support */
        ...
        (function () {
            ...
            function isTizenOrIOS() {
                return !!(navigator.userAgent.match(/Tizen|iPhone|iPad|iPod/i));
            }
            ...
            function getHeaders() {
                ...
                if (isTizenOrIOS()) {
                    headers = {
                        ...
                        'Referer': 'https://kvk.zone/',
                        'Origin': 'https://kvk.zone'
                    };
                }
                return headers;
            }
            ...
            function networkRequest(url, onSuccess, onError) {
